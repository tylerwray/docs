...
export const meta = {
  ...
  lastEdited: '2019-10-16T21:16:06.000Z'
}
...
For the final two options, navigate using the arrow keys and use the spacebar to select them.

Once the options have been selected, you will be prompted to enter your SendGrid API key, if you do not already
