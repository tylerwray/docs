...
export const meta = {
  ...
  lastEdited: '2019-10-07T03:20:28.000Z'
}
...
| **redirect** | <HelpLink href="#api-basics/types">String</HelpLink>       | No       | The redirect property will be take precedence over the `deploymentId`. |
