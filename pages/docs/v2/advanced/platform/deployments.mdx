...
export const meta = {
  ...
  lastEdited: '2019-10-21T10:47:24.000Z'
}
...
The [Now CLI](/download) provides an alternative way to manage your deployments.

You can find a full list of all the commands available in the [Now CLI Reference](/docs/now-cli/).
