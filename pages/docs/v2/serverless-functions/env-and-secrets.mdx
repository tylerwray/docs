...
export const meta = {
  ...
  lastEdited: '2019-10-02T19:18:13.000Z'
}
...
Environment variables are passed statically to an application, this means that they do not update in the application unless it is redeployed.
